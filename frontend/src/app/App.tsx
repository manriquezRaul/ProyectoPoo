...
import {
  ...
  RefreshCw, Timer, Gauge, BookOpenCheck, Check, FolderArchive, Settings2,
} from "lucide-react";
import {
...
function Sidebar({ activeNav, onNavChange, currentUser, onLogout }: { activeNav: string; onNavChange: (l: string) => void; currentUser: any; onLogout: () => void }) {
...
function HomeMain({ dashboard, currentUser, currentTime }: { dashboard: any; currentUser: any; currentTime: Date }) {
...
function SettingsMain({ currentUser, onUpdateUser }: { currentUser: any; onUpdateUser: (u: any) => void }) {
