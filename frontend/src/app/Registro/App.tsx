...
// Zero logic — every handler is an empty placeholder for integration.
...
// ─── HoneycombLogo ────────────────────────────────────────────────────────────
// Fixed 48×48 viewport. Scales via the `size` prop.
...
// ─── FeaturePill ──────────────────────────────────────────────────────────────
// h-9 (36px) · px-4 (16px) · gap-2 (8px) · rounded-full · border
...
// ─── TextInput ────────────────────────────────────────────────────────────────
// Shared text field: h-[44px] · px-[16px] · rounded-[12px] · border #E5E7EB
  ...
  return (
    <input
      ...
      className="
        ...
        text-[14px] font-[400] leading-[1.5] text-[#1e293b]
        placeholder:text-[#94a3b8]
        bg-white
        outline-none
        focus:ring-2 focus:ring-[#2563EB]/25 focus:border-[#2563EB]
...
// ─── PasswordInput ────────────────────────────────────────────────────────────
// Same height as TextInput, pr-[44px] to clear the eye icon button.
...
function PasswordInput({
  ...
  const handleToggleVisibility = () => {}; // wire: setShowPassword(v => !v)

  return (
    <div className="flex flex-col gap-[6px]">
      <label
        htmlFor={id}
        className="text-[13px] font-[500] leading-[1.5] text-[#475569]"
      >
        {label}
      </label>
      <div className="relative w-full">
        <input
          ...
          "
        />
        {/* Eye toggle — 40×44px hit target, 16px icon */}
        <button
          type="button"
          ...
          "
        >
          {/* Replace with <Eye size={16}/> / <EyeOff size={16}/> from lucide-react on integration */}
...
// ─── BrandingPanel ────────────────────────────────────────────────────────────
// Left 50% · gradient bg · hex watermark · logo · features · testimonial
...
function BrandingPanel() {
  return (
    <aside
      ...
      style={{
        background:
          "linear-gradient(145deg, #dbeafe 0%, #bfdbfe 35%, #93c5fd 70%, #60a5fa 100%)",
      }}
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-[48px] gap-[32px] max-w-[480px] w-full">
        ...
        <header className="flex flex-col items-center gap-[16px]">
          {/* Icon container: p-[16px] · rounded-[16px] · glass */}
        ...
        {/* Divider: 64px wide · 1px · blue-400/50 */}
        ...
        {/* Testimonial card: p-[20px] · rounded-[16px] · max-w-[280px] */}
...
function RegisterForm() {
  ...
  return (
    ...
    >
      {/* Form card: max-w-[448px], full width up to that */}
      <div className="w-full max-w-[448px]">

        {/* ── Mobile logo (hidden ≥ 1024px) ── */}
        ...
        {/* ── Form: gap-[20px] between field groups ── */}
        <form
        ...
        >
          ...
          {/* University Email */}
          <FieldGroup label="University Email" htmlFor="email">
            <TextInput
              id="email"
              name="email"
              type="email"
          ...
          {/* Terms notice: mt-[-4px] to tighten gap after last field */}
          <p className="mt-[-4px] text-[12px] font-[400] leading-[1.6] text-[#94a3b8]">
            By creating an account you agree to our{" "}
            <a
              href="#"
              className="text-[#2563EB] hover:text-[#1d4ed8] underline underline-offset-[3px] transition-colors duration-150"
            >
              Terms of Service
            </a>{" "}
            and{" "}
          ...
          {/* ── CTA Button ──
              h-[48px] · rounded-[12px] · bg #2563EB · text white 14px/600
          ...
          */}
          <button
            ...
            className="
              ...
              text-white text-[14px] font-[600] leading-none tracking-[0.1px]
        ...
        {/* ── Sign-in toggle: mt-[24px] · text-[14px] ── */}
        <p className="mt-[24px] text-center text-[14px] font-[400] leading-[1.5] text-[#64748b]">
          ...
          <button
            ...
            className="
              font-[600] text-[#2563EB]
              hover:text-[#1d4ed8] hover:underline underline-offset-[3px]
              transition-colors duration-150
